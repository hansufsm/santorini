 ...
 *
 * Política: reservas nunca são deletadas permanentemente.
 * deleteReservation faz soft delete (preenche deletedAt + status=cancelada).
 */
...
// Retorna reservas de uma unidade específica (portal do associado/morador)
